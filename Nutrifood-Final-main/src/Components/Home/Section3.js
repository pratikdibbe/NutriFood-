        ...
        <>
            ...
            <div className='section3 container'>
                <div>
                    ...
                    <p id='mypara'>
                        NUTRI-FOOD's Food Nutrition Calculator allows you to choose from thousands of foods and brands, and see nutrition facts such as calories, fat, protein, carbohydrates, fiber and sugar. Get started by entering your food name.
                    </p>
                    <input
                        type='text'
